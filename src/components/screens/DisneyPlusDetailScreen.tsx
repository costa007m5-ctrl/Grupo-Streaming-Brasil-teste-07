...
import { PlayIcon, PlusIcon, XMarkIcon, CheckIcon, ShareIcon, WhatsAppIcon, TelegramIcon, FacebookIcon, DocumentDuplicateIcon, UsersIcon, PauseIcon, BackwardIcon, ForwardIcon, SpeakerWaveIcon, SpeakerXMarkIcon } from '../ui/Icons';
