...
import { ArrowLeftIcon, ShareIcon, ArrowDownTrayIcon } from '../ui/Icons';
...
const StatementDetailScreen: React.FC<StatementDetailScreenProps> = ({ onDone, transaction }) => {
        ...
        try {
            ...
            if (file) {
                await navigator.share({
                    ...
                    text: `Comprovante de transação de R$ ${transaction.amount.toFixed(2)}`,
                    files: [file],
                });
            }
        } catch (error) {
        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <header className="sticky top-0 bg-white/80 backdrop-blur-sm z-10 p-4">
                <div className="relative flex justify-center items-center text-gray-800 w-full h-8">
                    ...
                    <h1 className="text-xl font-bold">Detalhes da Transação</h1>
                </div>
            </header>
            ...
            <main className="p-4 pt-2 space-y-4">
                ...
                <div ref={receiptRef} className="bg-white p-5 rounded-xl shadow-sm space-y-4">
                    <h3 className="text-center font-bold text-lg text-purple-800 border-b-2 border-dashed border-gray-200 pb-3">Comprovante de Transação</h3>
